        ...
        switch (itemViewType){
            case ITEM_ORDER:
                ...
                holderView.tv_plus.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    {
                        modifyCountInterface.doIncrease(finalHolderView.et_total,position,finalHolderView
                ...
                holderView.tv_minus.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        modifyCountInterface.doDecrease(finalHolderView.et_total,position,finalHolderView.et_total.getText().toString().trim());
                    }
                });
                break;
            case ITEM_STRETCH:
